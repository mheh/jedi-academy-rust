...
- [ ] `src/code/renderer/tr_terrain.rs` (16)
- [ ] `src/code/game/g_items.rs` (13)
- [ ] `src/code/server/server_h.rs` (12)
- [ ] `src/code/game/AI_AssassinDroid.rs` (11)
- [ ] `src/code/cgame/FxUtil_h.rs` (11)
- [ ] `src/code/jpeg-6/jdhuff.rs` (10)
- [ ] `src/code/game/g_svcmds.rs` (10)
- [ ] `src/code/game/g_missile.rs` (10)
- [ ] `src/code/game/AI_Stormtrooper.rs` (10)
...
- [ ] `src/codemp/jpeg-6/jcmaster.rs` (14)
- [ ] `src/codemp/client/FxUtil_h.rs` (12)
- [ ] `src/codemp/ui/ui_shared_h.rs` (10)
- [ ] `src/codemp/RMG/RM_Instance_Group.rs` (10)
- [ ] `src/codemp/RMG/RM_Instance_Random.rs` (9)
- [ ] `src/codemp/RMG/RM_InstanceFile.rs` (8)
- [ ] `src/codemp/RMG/RM_Instance.rs` (8)
- [ ] `src/codemp/RMG/RM_Instance_Group_h.rs` (8)
- [ ] `src/codemp/renderer/tr_terrain.rs` (8)
- [ ] `src/codemp/RMG/RM_Terrain.rs` (7)
- [ ] `src/codemp/cgame/cg_scoreboard.rs` (7)
- [ ] `src/codemp/cgame/cg_drawtools.rs` (7)
- [ ] `src/codemp/RMG/RM_Manager.rs` (6)
- [ ] `src/codemp/RMG/RM_Instance_BSP.rs` (6)
- [ ] `src/codemp/jpeg-6/jdsample.rs` (6)
- [ ] `src/codemp/jpeg-6/jdapimin.rs` (6)
- [ ] `src/codemp/cgame/cg_servercmds.rs` (6)
- [ ] `src/codemp/RMG/RM_Path.rs` (5)
...
- [ ] `src/codemp/RMG/RM_Manager_h.rs` (4)
- [ ] `src/codemp/RMG/RM_Instance_Void.rs` (4)
...
- [ ] `src/codemp/RMG/RM_Path_h.rs` (1)
- [ ] `src/codemp/RMG/RM_Objective.rs` (1)
- [ ] `src/codemp/RMG/RM_Objective_h.rs` (1)
