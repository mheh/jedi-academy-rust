...
// Conditional compilation would be handled at crate level for _XBOX and _UI features.
// For now, we provide the definition unconditionally.
pub static HolocronIcons: &[&str] = &[
