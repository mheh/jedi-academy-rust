...
extern "C" {
    ...
    fn memset(dest: *mut c_void, val: c_int, count: usize) -> *mut c_void;
}

// bk001207 - we need something under Linux, too. Mac?
// #if 1 // defined(C_ONLY) // bk010102 - dedicated?

pub unsafe fn Com_Memcpy(dest: *mut c_void, src: *const c_void, count: usize) {
    memcpy(dest, src, count);
}

pub unsafe fn Com_Memset(dest: *mut c_void, val: c_int, count: usize) {
...
// }
//
// pub unsafe fn Com_Prefetch(s: *const c_void, bytes: c_uint, r#type: e_prefetch);
//
// pub unsafe fn _copyDWord(dest: *mut c_uint, constant: c_uint, count: c_uint) {
...
// pub unsafe fn Com_Memcpy(dest: *mut c_void, src: *const c_void, count: usize) {
// 	Com_Prefetch(src, count as c_uint, e_prefetch::PRE_READ);
// 	core::arch::asm!("
// 		pushl		%%edi
// 		pushl		%%esi
// 		//mov		ecx,count
...
// 	}
//
// 	fillval = val as c_uint;
//
// 	fillval = fillval | (fillval << 8);
// 	fillval = fillval | (fillval << 16);		// fill dword with 8-bit pattern
//
// 	_copyDWord(dest as *mut c_uint, fillval, (count / 4) as c_uint);
//
// 	core::arch::asm!("     		// padding of 0-3 bytes
// 		//mov		ecx,count
// 		movl		%%ecx, %%eax
// 		andl		$3, %%ecx
// 		jz		1f
...
//
// 	match r#type {
// 		e_prefetch::PRE_WRITE => {},
// 		e_prefetch::PRE_READ | e_prefetch::PRE_READ_WRITE => {
// 			core::arch::asm!("
// 				//mov		ebx,s
// 				//mov		ecx,bytes
