...
pub type float_DCT_method_ptr = unsafe extern "C" fn(*mut f32);
...
pub const RANGE_MASK: c_int = 1023; /* 2 bits wider than legal samples */
...
extern "C" {
    ...
    pub fn jpeg_fdct_float(data: *mut f32);

    pub fn jpeg_idct_islow(
        cinfo: *mut c_void,
        compptr: *mut c_void,
        coef_block: *mut DCTELEM,
