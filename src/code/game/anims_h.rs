// playerAnimations
// Ported from oracle/code/game/anims.h
...
// SABER_ANIM_GROUP_SIZE is defined in the original as a macro:
// #define SABER_ANIM_GROUP_SIZE (BOTH_A2_T__B_ - BOTH_A1_T__B_)
// This represents the size difference between adjacent saber animation groups.
// In Rust, this is calculated based on enum variant position:
// BOTH_A2_T__B_ is at position 203 and BOTH_A1_T__B_ is at position 126
// So SABER_ANIM_GROUP_SIZE = 203 - 126 = 77
pub const SABER_ANIM_GROUP_SIZE: u32 = 77;
