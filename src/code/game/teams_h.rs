// Ported from oracle/code/game/teams.h
...
extern "C" {
    pub static TeamTable: *mut stringID_table_t;
}
...
extern "C" {
    pub static ClassTable: *mut stringID_table_t;
}

// Stub: stringID_table_t is defined elsewhere
// This is a forward declaration to maintain structural coherence of this header port
#[repr(C)]
pub struct stringID_table_t {
    // Details defined in actual stringID_table_t declaration
    _opaque: [u8; 0],
}
