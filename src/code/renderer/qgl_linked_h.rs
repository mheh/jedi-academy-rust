...
// OpenGL type aliases for FFI compatibility
...
extern "C" {
    ...
    pub fn glCallLists(n: GLsizei, type_: GLenum, lists: *const c_void);
    pub fn glClear(mask: GLuint);
    ...
    pub fn glColorPointer(size: GLint, type_: GLenum, stride: GLsizei, pointer: *const c_void);
    ...
    pub fn glDrawPixels(width: GLsizei, height: GLsizei, format: GLenum, type_: GLenum, pixels: *const c_void);
    pub fn glEdgeFlag(flag: GLboolean);
    pub fn glEdgeFlagPointer(stride: GLsizei, pointer: *const c_void);
    ...
    pub fn glFrustum(left: GLdouble, right: GLdouble, bottom: GLdouble, top: GLdouble, near_val: GLdouble, far_val: GLdouble);
    ...
    pub fn glGetTexImage(target: GLenum, level: GLint, format: GLenum, type_: GLenum, pixels: *mut c_void);
    ...
    pub fn glIndexPointer(type_: GLenum, stride: GLsizei, pointer: *const c_void);
    ...
    pub fn glInitNames();
    pub fn glInterleavedArrays(format: GLenum, stride: GLsizei, pointer: *const c_void);
    ...
    pub fn glNormalPointer(type_: GLenum, stride: GLsizei, pointer: *const c_void);
    pub fn glOrtho(left: GLdouble, right: GLdouble, bottom: GLdouble, top: GLdouble, near_val: GLdouble, far_val: GLdouble);
    ...
    pub fn glPushAttrib(mask: GLuint);
    pub fn glPushClientAttrib(mask: GLuint);
    pub fn glPushMatrix();
    ...
    pub fn glTexCoordPointer(size: GLint, type_: GLenum, stride: GLsizei, pointer: *const c_void);
    ...
    pub fn glTexImage1D(target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, border: GLint, format: GLenum, type_: GLenum, pixels: *const c_void);
    ...
    pub fn glTexSubImage1D(target: GLenum, level: GLint, xoffset: GLint, width: GLsizei, format: GLenum, type_: GLenum, pixels: *const c_void);
    ...
    pub fn glVertexPointer(size: GLint, type_: GLenum, stride: GLsizei, pointer: *const c_void);
