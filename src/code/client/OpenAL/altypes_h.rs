...
use core::ffi::{c_char, c_short, c_int, c_uint, c_ushort, c_uchar, c_void};
...
/* Bad value. */
pub const AL_INVALID: c_int = -1;

/* Disable value. */
pub const AL_NONE: c_int = 0;

/* Boolean False. */
pub const AL_FALSE: c_int = 0;

/* Boolean True. */
pub const AL_TRUE: c_int = 1;

/**
  * Indicate the type of AL_SOURCE.
  * Sources can be spatialized
  */
pub const AL_SOURCE_TYPE: c_int = 0x200;

/** Indicate source has absolute coordinates. */
pub const AL_SOURCE_ABSOLUTE: c_int = 0x201;
 ...
 * Default:  1.0
 */
pub const AL_ROLLOFF_FACTOR: c_int = 0x1021;
 ...
 * Default:  0.0
 */
pub const AL_PAN: c_int = 0x1024;

/**
 * Get the playing time of a stream.
 * Range:	 [0.0 - infinity]
 */
pub const AL_TIME: c_int = 0x1025;
 ...
 * Range:	 [0 - 255]
 */
pub const AL_CHANNEL_MASK: c_int = 0x3000;
...
pub const AL_FORMAT_MONO4: c_int = 0x1104;
pub const AL_FORMAT_STEREO4: c_int = 0x1105;
...
pub const AL_DATA: c_int = 0x2005;
...
/** Errors: No Error. */
pub const AL_NO_ERROR: c_int = AL_FALSE;
...
pub const AL_MEMORY_USED: c_int = 0xB005;
pub const AL_MEMORY_ALLOCATOR: c_int = 0xB006;
pub const AL_MEMORY_DEALLOCATOR: c_int = 0xB007;
pub const AL_STEREO: c_int = 0xB008;
