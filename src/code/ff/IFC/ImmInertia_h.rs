...
pub const IMM_INERTIA_DEFAULT_COEFFICIENT: DWORD = 2500;
pub const IMM_INERTIA_DEFAULT_SATURATION: DWORD = 10000;
pub const IMM_INERTIA_DEFAULT_MIN_ACCELERATION: DWORD = 0;
...
impl CImmInertia {
    ...
    pub fn GetIsCompatibleGUID(&self, guid: &GUID) -> BOOL {
        ...
        if guid.data1 == GUID_Imm_Inertia.data1
            && guid.data2 == GUID_Imm_Inertia.data2
            && guid.data3 == GUID_Imm_Inertia.data3
            && guid.data4 == GUID_Imm_Inertia.data4
        {
            1 // TRUE
        } else {
            0 // FALSE
    ...
    pub fn ChangeMinAccelerationX(&mut self, dwMinAcceleration: DWORD) -> BOOL {
        0
    }

    pub fn ChangeMinAccelerationY(&mut self, dwMinAcceleration: DWORD) -> BOOL {
        0
    }

    pub fn ChangeMinAcceleration(&mut self, dwMinAcceleration: DWORD) -> BOOL {
        0
    }

    pub fn GetMinAccelerationX(&self, dwMinAcceleration: &mut DWORD) -> BOOL {
        0
    }

    pub fn GetMinAccelerationY(&self, dwMinAcceleration: &mut DWORD) -> BOOL {
        0
    }
