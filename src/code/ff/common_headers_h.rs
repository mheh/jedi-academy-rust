...
// Translation of oracle/code/ff/common_headers.h
//
// Note: This header file contains only compiler pragmas, conditional compilation,
// and includes. In Rust, we use the module system instead of textual includes.
// The pragmas are MSVC-specific and do not apply to Rust compilation.
